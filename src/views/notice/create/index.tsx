import { useMutationCreateCenterNoticeByCenterId } from "@/entities/notice/model";
...
const NoticeCreate = () => {
    ...
    const createMutation = useMutationCreateCenterNoticeByCenterId((res: any) => {
        if (res.data) {
            message.success("공지사항 등록 성공했습니다.")
            navigate(-1)
        }
    })
            ...
            <Flex justify="flex-start" gap={50}>
                <div style={{ padding: '20px 24px' }}>
                    ...
                    <Flex align="center" style={{ marginTop: 24, justifyContent: 'space-between' }}>
                        ...
                        <Button type="primary" onClick={clickCreateButton}>생성하기</Button>
                    </Flex>
                </div>
